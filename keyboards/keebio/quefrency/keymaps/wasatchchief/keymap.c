...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_with_macro(
    ...
    KC_F2,   KC_F3,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_UP,  FN, 
    KC_F4,   KC_F5,   KC_LCTL, KC_LGUI, KC_LALT, FN,      KC_SPC,  KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI, GUI_L,   KC_DOWN, CTL_R
  ),

  [_FN] = LAYOUT_60_with_macro(
    RESET,   KC_NO,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,

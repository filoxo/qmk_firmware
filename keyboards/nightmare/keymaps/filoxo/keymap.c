...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split(/* Base */
        ...
        KC_PGUP, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLSH, KC_RSFT, MO(3),
        KC_PGDN, KC_LGUI, KC_LALT, MO(1), KC_SPACE, KC_SPACE, KC_RGUI, KC_RCTL, MO(2)),

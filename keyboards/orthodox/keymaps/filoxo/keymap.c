...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_LBRC, KC_VOLD,          KC_VOLU,KC_RBRC,           KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    LOWER,   KC_LGUI, KC_BSPC,          KC_SPC, KC_ENT,   RAISE,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH \
  ),
  ...
  [_RAISE] = LAYOUT( \
    ...
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,            _______, _______,          _______, _______,          KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
